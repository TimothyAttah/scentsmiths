...
export const orderPayReducer = (state = {}, action) => {
	switch (action.type) {
		case ORDER_TYPES.ORDER_PAY_REQUEST:
			return { loading: true };
		...
		case ORDER_TYPES.ORDER_PAY_FAIL:
			return {
				loading: false,
				error: action.payload,
			};

		case ORDER_TYPES.ORDER_PAY_RESET:
			return {};
...
export const orderListMyReducer = (state = {orders: []}, action) => {
	switch (action.type) {
		case ORDER_TYPES.ORDER_LIST_MY_ORDER_REQUEST:
			return { loading: true };
		...
		case ORDER_TYPES.ORDER_LIST_MY_ORDER_FAIL:
			return {
				loading: false,
				error: action.payload,
			};
...
export const orderListReducer = (state = { orders: [] }, action) => {
	switch (action.type) {
		case ORDER_TYPES.ORDER_LIST_ALL_ORDER_REQUEST:
			return { loading: true };
		...
		case ORDER_TYPES.ORDER_LIST_ALL_ORDER_FAIL:
			return {
				loading: false,
				error: action.payload,
			};
...
export const orderDeliverReducer = (state = {}, action) => {
	switch (action.type) {
		case ORDER_TYPES.ORDER_DELIVER_REQUEST:
			return { loading: true };
		...
		case ORDER_TYPES.ORDER_DELIVER_FAIL:
			return {
				loading: false,
				error: action.payload,
			};

		case ORDER_TYPES.ORDER_DELIVER_RESET:
			return {};
